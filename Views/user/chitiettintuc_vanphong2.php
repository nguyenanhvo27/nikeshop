            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 order-md-1 order-1">
                    <div class="blog__details__text">
                        ...
                        <p>
                        <h1 class="u-text u-text-1"><?php echo $dataCategory[3]["category"]; ?></h1>
                        </p>
                        <h3>
                            <p class="u-text u-text-2"><?php echo $dataCategory[3]["categorymini"]; ?></p>
                        </h3>
                        <p class="u-text u-text-2"><?php echo $dataCategory[3]["categorybig"]; ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5><a class="u-text u-text-2" href="./chitiettintuc_vanphong1.php"><?php echo $dataCategory[2]["category"]; ?></a></h5>
